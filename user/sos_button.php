...
function sendSOS() {
    ...
    // Add clicked class to change button color
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            // Simulate sending SMS and show a success popup
            setTimeout(() => {
                alert("SOS alert sent successfully!"); // Popup message
                window.location.href = `sos_action.php?lat=${latitude}&lon=${longitude}`;
            }, 1000); // Simulate delay for sending
        }, function() {
            // If geolocation fails, alert user and proceed without location
            alert("Failed to retrieve your location. Sending SOS without location.");
            window.location.href = "sos_action.php";
        });
    } else {
        alert("Geolocation is not supported by this browser.");
        // Proceed without location if geolocation isn't available
        window.location.href = "sos_action.php";
    }
}
</script>
